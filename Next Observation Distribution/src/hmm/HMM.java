...
public class HMM {
	...
	int n = 0;
	try {
            Scanner numFile = new Scanner(new File("hmm3_01.in"));
    ...
    public void BaumWelch(double[][] a, double[][] b, double[] pi, int[] o){
    	...
    	this.b = b;
    	this.pi = pi;
    	double[][] alphaMatrix = alphaPassScale(o);
		double[][] betaMatrix = betaPassScale(o);
	    ...
	    //Prints all alphas at time t
	     ...
	     //  }
	      ...
	      return fwd;
            ...
            //taken from stamp
  public double[][] alphaPassScale(int[] o) {
  ...
  //taken from stamp
  public double[][] betaPassScale(int[] o) {
	    int T = o.length;
...
/*		   	for(int j=0; j<o.length; j++){
	...
	return c;  
		...
		public static void main(String args[]) {
				...
				HMM h = new HMM();
				h.readFile();
				double[][] alphaMatrix = h.alphaPassScale(h.getObs());
				double[][] betaMatrix = h.betaPassScale(h.getObs());
